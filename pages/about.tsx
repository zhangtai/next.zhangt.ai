      ...
      <Layout>
        <p>
          ...
          <Text>
            ...
            Hugo, Next.js + Tailwind + Contentful. Both are excellent and absolute satisfy my
            requirements, but I just do not want to comfortable with something
            and want to try new ones.
          </Text>
          <Text>
          ...
          <Text>
            There are still something I need to work to improve in current approach:
            <ul>
              <li>Navbar, the official component of NextUI is coming soon, I want to wait for it</li>
              <li>SyntaxHighlighter approach for code fence no highlight the snippet itself in VSCode</li>
            </ul>
          </Text>
        </p>
      </Layout>
